...
Let's practise LP-like package development on [`extremeMetrics` package](https://github.com/mi2-warsaw) which is a set of `Extreme and incredibly crazy set of metrics`.
